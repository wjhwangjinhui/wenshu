...
def get_data(**kwargs):
    ...
    headers = {
        ...
        # 'Host': 'wenshu.court.gov.cn',
        # 'Origin': 'http://wenshu.court.gov.cn',
        # 'Referer': 'http://wenshu.court.gov.cn/list/list/?sorttype=1&number=&guid={}&conditions=searchWord+2+AJLX++%E6%A1%88%E4%BB%B6%E7%B1%BB%E5%9E%8B:{}&conditions=searchWord+QWJS+++%E5%85%A8%E6%96%87%E6%A3%80%E7%B4%A2:{}'.format(guid,parse.quote('民事案件'), parse.quote(key))
    }
...
if __name__ == '__main__':
    ...
    # data = main(**kwargs)
    # print(data)
    guid = 'b901c5fc-a410-30ff03fd-96e2956c76d0'
    key = '王进'
    a = {'Referer': 'http://wenshu.court.gov.cn/list/list/?sorttype=1&number=&guid={}&conditions=searchWord+2+AJLX++%E6%A1%88%E4%BB%B6%E7%B1%BB%E5%9E%8B:{}&conditions=searchWord+QWJS+++%E5%85%A8%E6%96%87%E6%A3%80%E7%B4%A2:{}'.format(
        guid, parse.quote('民事案件'), parse.quote(key))}
    print(a)
